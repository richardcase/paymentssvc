...
// DeletePaymentParams contains all the bound params for the delete payment operation
...
func (o *DeletePaymentParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeletePaymentParams) validateID(formats strfmt.Registry) error {
